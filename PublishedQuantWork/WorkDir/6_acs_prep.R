...
poverty <- acs.fetch(geography = geo.make(state = "MA", county = "Suffolk",
                                          tract = "*"), table.name = "POVERTY STATUS IN THE PAST 12 MONTHS OF FAMILIES")
poverty <- acs.fetch(endyear = 2011,span=5,geography=geo.make(state = "MA", county = "Suffolk",
...
pov.2 <-  poverty[,c(11, "HC03_EST_VC01","HC01_EST_VC03","HC01_EST_VC05","HC01_EST_VC06")]
